...
impl AppState {
    ...
    pub(crate) fn new_inner(
        ...
        .chain({
            ...
            let orchardpay =
                OrchardPayScreen::new(&active_context, OrchardPaySubscreen::MostRecent);
            [(
...
mod shutdown_tests {
    ...
    impl TestDataDir {
        fn enter() -> Self {
            let lock = crate::test_support::ORCHARDPAY_DATA_DIR_LOCK
                .lock()
            ...
            unsafe { std::env::set_var("ORCHARDPAY_DATA_DIR", temp_dir.path()) };
            Self {
                prior,
                _temp_dir: temp_dir,
                _lock: lock,
    ...
    impl Drop for TestDataDir {
        fn drop(&mut self) {
            ...
            unsafe {
                match &self.prior {
                    Some(value) => std::env::set_var("ORCHARDPAY_DATA_DIR", value),
